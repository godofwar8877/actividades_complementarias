				    ...
				    <table class="striped">
					  ...
					  <tbody>
					    ...
					    <tr>
							...
							<td><a class="btn waves-effect waves-light grey" href="Modificar_estudiante.php?Num_control=<?php echo $rs2['Num_control']; ?>">CAMBIAR</a></td>
							<td><a class="btn waves-effect waves-light black" onclick="delete_estudiante(<?php echo $rs2['Num_control']; ?>)" href="#">ELIMINAR</a>
					    </tr>
					    <?php
				          	}
				        ?>
