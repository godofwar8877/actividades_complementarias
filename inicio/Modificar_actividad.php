		...
		<div class="container">
			<div class="row">
							...
							<div class="row">
								<div class="input-field col s12">
									<i class="material-icons prefix">account_circle</i>
          							<input placeholder="<?php echo $rs_details['Num_actividad'] ?>" name="Num_actividad_2" type="text">
        						</div>
							</div>
              ...
              <div class="row">
								<div class="input-field col s12">
									<i class="material-icons prefix">account_circle</i>
          							<input placeholder="<?php echo $rs_details['Nombre_actividad'] ?>" name="Nombre_actividad" type="text">
        						</div>
							</div>
