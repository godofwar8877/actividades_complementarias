...
<?php
  ...
  $statement = $pdo->prepare($sql);
	...
	$sql_status = 'SELECT departamento.*, trabajador.Nombre_trabajador FROM departamento INNER JOIN trabajador ON trabajador.RFC_trabajador = departamento.trabajador_RFC_trabajador ORDER BY nombre_departamento';
...
<html lang="es">
	...
	<body>
        ...
        <nav class="black">
			...
			<div class="row">
					<div class="col s12">
						<h2>Ejecucionn de una sentencia SQL</h2>
						<hr>
						<h3>Datos SQL</h3>
						<pre>
